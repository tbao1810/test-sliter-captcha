(function () {
    ...
    _proto.initImg = function () {
        ...
        img.setSrc = function () {
            ...
            if (!src || src === '') src = 'http://picsum.photos/' + that.options.width + '/' + that.options.height + '/?image=' + Math.round(Math.random() * 20);
            if (isIE) { 
